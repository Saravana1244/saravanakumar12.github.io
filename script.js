<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      navToggle.addEventListener('click', () => {
        ...
        // CSS handles nav.open state for aesthetics and display properties.
      });
      ...
      document.querySelectorAll('[data-close], .modal').forEach(el => {
        el.addEventListener('click', (e) => {
          // Check if the click is directly on the modal backdrop or the close button
          if (e.target.closest('.modal-body') && !el.hasAttribute('data-close') && e.target !== el) return;
